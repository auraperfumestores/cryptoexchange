      ...
      {walletConnected && walletEligible === false && (
        <div style={{ ...S.card, padding: '24px 20px', textAlign: 'center' }}>
          ...
          <a
            ...
            target="_blank" rel="noopener noreferrer"
            style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '11px 22px', borderRadius: 11, background: '#25D366', color: '#fff', fontSize: 13, fontWeight: 800, textDecoration: 'none' }}
          >
