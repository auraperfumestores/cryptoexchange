...
export const metadata: Metadata = {
  title: 'Terms of Service — SwapINR',
  description: 'Terms of Service governing the use of the SwapINR USDT to INR exchange platform.',
};
...
const SECTIONS = [
  {
    ...
    body: [
      `These Terms of Service ("Terms") constitute a legally binding agreement between you ("User," "you," or "your") and SwapINR ("SwapINR," "we," "us," or "our") governing your access to and use of the SwapINR website, mobile interfaces, APIs, and all related services (collectively, the "Platform"), which facilitate the conversion of Tether (USDT) to Indian Rupees (INR) and related settlement services via UPI, IMPS, NEFT, and RTGS.`,
  ...
  },
  {
    ...
    body: [
      ...
      `SwapINR reserves the right, at its sole discretion, to refuse service, suspend, or terminate accounts of users who do not meet, or are found to no longer meet, the eligibility criteria set out above.`,
    ],
  },
  {
    ...
    body: [
      ...
      `You must notify us immediately at the earliest opportunity of any unauthorized use of your account or any other breach of security. SwapINR will not be liable for any loss or damage arising from your failure to comply with this security obligation. You are responsible for all activities that occur under your account, whether or not authorized by you, except to the extent such activity is a direct result of SwapINR's gross negligence or willful misconduct.`,
  ...
  },
  {
    ...
    body: [
      `SwapINR operates as a peer-to-platform exchange facilitator, enabling users to convert USDT held on supported blockchain networks (BEP-20, ERC-20, and TRC-20) into INR, and to receive settlement via UPI, IMPS, NEFT, or RTGS, subject to the limits, fees, and processing times displayed on the Platform at the time of the transaction.`,
      `Exchange rates displayed on the Platform are indicative and may fluctuate based on prevailing market conditions until the point of trade execution. The rate locked at order confirmation is final and binding for that specific order. SwapINR does not guarantee any specific rate, return, or profit and is not an investment, savings, or wealth-management product.`,
      `SwapINR does not act as a custodian of your digital assets beyond the time strictly necessary to process a confirmed transaction. You are solely responsible for the security of your wallets, private keys, and seed phrases prior to and outside of an active transaction with the Platform.`,
    ],
  },
  {
    title: '6. Fees & Settlement',
    body: [
      `Applicable fees, if any, are disclosed transparently on the order confirmation screen prior to you finalizing a transaction. SwapINR reserves the right to revise its fee structure from time to time, with such changes taking effect prospectively and not affecting orders already confirmed.`,
      `Standard settlement timelines are displayed on the Platform and may vary based on network congestion on the relevant blockchain, banking-hours restrictions on UPI/IMPS/NEFT/RTGS rails, and the outcome of any fraud or compliance screening triggered by your transaction. SwapINR will make commercially reasonable efforts to settle within the displayed timeframe but does not guarantee settlement within any specific period where delay arises from causes outside its reasonable control, including those described in Section 11 (Force Majeure).`,
    ],
  },
  {
    ...
    body: [
      ...
      `Any violation of this Section may result in immediate suspension or termination of your account, forfeiture of any pending transaction, and referral to law enforcement or regulatory authorities, in addition to any other remedies available to SwapINR under law or these Terms.`,
    ],
  },
  {
    title: '8. Risk Disclosure',
    body: [
      `Virtual digital assets, including USDT, are subject to high market volatility, regulatory uncertainty, and technological risk. You acknowledge that you are transacting with the Platform at your own risk and that SwapINR does not provide financial, investment, legal, or tax advice. You are solely responsible for evaluating the merits and risks of any transaction and for any applicable tax obligations, including under the Income-tax Act, 1961, arising from your transactions on the Platform.`,
      `Blockchain transactions are irreversible once confirmed on the underlying network. SwapINR is not responsible for losses arising from user error, including but not limited to sending assets to an incorrect address, to an unsupported network, or in an incorrect amount.`,
    ],
  },
  {
    title: '9. Limitation of Liability',
    body: [
      `To the maximum extent permitted by applicable law, SwapINR, its directors, officers, employees, and affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, arising out of or in connection with your use of, or inability to use, the Platform, even if advised of the possibility of such damages.`,
      `Notwithstanding the foregoing, nothing in these Terms limits or excludes SwapINR's liability for fraud, willful misconduct, or gross negligence, or any other liability that cannot be excluded or limited under applicable Indian law.`,
      `SwapINR's aggregate liability arising out of or relating to these Terms or your use of the Platform shall not exceed the total fees paid by you to SwapINR in the six (6) months preceding the event giving rise to the claim.`,
    ],
  },
  {
