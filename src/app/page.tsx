...
const TESTIMONIALS = [
  ...
  { name: 'Nikhil S.', location: 'Pune',      trade: '₹1,20,000', rating: 5, photo: '/testimonials/t4.jpg', quote: 'Sold TRC-20 USDT and received INR via IMPS in under 10 minutes on a Sunday. Their live chat support confirmed my transfer instantly.' },
